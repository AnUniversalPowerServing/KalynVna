...
public class AppFormBuilder {
  ...
  public static void main(String args[]) throws InterruptedException {
    ...
    for(WebElement webElement : webElementList){
    	...
    	for(WebElement webElementHeader : webElement.findElements(By.tagName("h6"))){
    	   System.out.println(webElementHeader.getText());
    	   for(WebElement webElementDesc : webElement.findElements(By.tagName("p"))){
    		  System.out.println(webElementDesc.getText());
    	   }
    	}
     webElement.click();
     break;
