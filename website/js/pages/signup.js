...
function signup_mentionProfile(){
 ...
 } else { alert_display_warning('W006'); }
 } else { alert_display_warning('W005'); }
 } else { alert_display_warning('W004'); }
 } else { alert_display_warning('W003'); }
...
function signup_birthZodiacCommunity(){
 ...
 } else { alert_display_warning('W021'); }
 } else { alert_display_warning('W020'); }
 } else { alert_display_warning('W019'); }
 } else { alert_display_warning('W018'); }
...
{ action:'SIGNUP_AUTHENTICATION', surName: signUp_mentionProfile_surName, name: signUp_mentionProfile_name, 
  ...
  occType: signUp_mentionProfile_occupationType, 
...
exp_occType: signUp_prefSpouse_expectedOccpnType, exp_motherTongue: signUp_prefSpouse_expectedMTongue },
function(response){
