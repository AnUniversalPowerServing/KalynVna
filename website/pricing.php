...
<div class="list-group-item">
  ...
  <div class="row mtop15p">
    <div class="col-xs-12">
	  <a href="<?php echo $_SESSION["PROJECT_URL"];?>app/signup/bronze">
	    <button class="btn bg-pink form-control"><b>Signup</b></button>
	  </a>
...
<div class="list-group-item">
  ...
  <div class="row mtop15p">
    <div class="col-xs-12">
	  <a href="<?php echo $_SESSION["PROJECT_URL"];?>app/signup/silver">
	    <button class="btn bg-green form-control"><b>Signup</b></button>
	  </a>
	  <div align="center" class="mtop15p">
...
<div class="list-group-item">
  ...
  <div class="row mtop15p">
    <div class="col-xs-12">
	  <a href="<?php echo $_SESSION["PROJECT_URL"];?>app/signup/gold">
	    <button class="btn bg-yellow form-control"><b>Signup</b></button>
	  </a>
	   <div align="center" class="mtop15p">
