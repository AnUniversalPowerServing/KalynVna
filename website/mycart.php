...
<div align="center" class="list-group-item"><h4><b>BRONZE PLAN</b></h4></div>
<div class="list-group-item">
  ...
  <div class="row mtop15p">
    ...
    <div class="col-xs-10">Once your Profile is filled, profiles that you are expecting qualificcations are sent to your 
	Dashboard based on you expecting occupation, highest degree and living status.</div>
  </div>
  <div class="row mtop15p">
    <div class="col-xs-12">
	  <div align="center" class="mtop15p">
        <a href="https://www.instamojo.com/@kalyanaveena/l92f99ed7faf54ef2af6b525404f9c3a4/" rel="im-checkout" 
         data-behaviour="remote" data-style="dark" data-text="Make out Payment"></a>
...
<div class="col-md-3">
<div class="list-group">
<div align="center" class="list-group-item"><h4><b>SILVER PLAN</b></h4></div>
<div class="list-group-item">
  <div class="container-fluid">
  <div class="row">
    <div class="mtop15p" class="col-xs-12"><b>Features</b></div>
  ...
  <div class="row mtop15p">
    <div class="col-xs-12">
	  <div align="center" class="mtop15p">
	    <a href="https://www.instamojo.com/@kalyanaveena/l4222a8f801d948eca83d103b87486f23/" rel="im-checkout" 
	    data-behaviour="remote" data-style="dark" data-text="Make out Payment"></a>
	    <script src="https://js.instamojo.com/v1/button.js"></script>
      </div>
	</div>
...
<div class="col-md-3">
<div class="list-group">
<div align="center" class="list-group-item"><h4><b>GOLD PLAN</b></h4></div>
<div class="list-group-item">
  <div class="container-fluid">
  <div class="row">
    <div class="mtop15p" class="col-xs-12"><b>Features</b></div>
  ...
  <div class="row mtop15p">
    <div class="col-xs-12">
	   <div align="center" class="mtop15p">
	      <a href="https://www.instamojo.com/@kalyanaveena/l3a81ff14addb4ce88289caafbbd02d22/" rel="im-checkout" 
	      data-behaviour="remote" data-style="dark" data-text="Make out Payment"></a>
	     <script src="https://js.instamojo.com/v1/button.js"></script>
       </div>
	</div>
...
<div class="col-md-3">
<div class="list-group">
<div align="center" class="list-group-item"><h4><b>FREE PLAN</b></h4></div>
<div class="list-group-item">
  <div class="container-fluid">
  <div class="row">
    <div class="mtop15p" class="col-xs-12"><b>Features</b></div>
  ...
  <div class="row mtop15p">
    ...
    <div class="col-xs-10">You can Sense <b>No</b> full profiles.</div>
  </div>
  <div class="row mtop15p">
    <div class="col-xs-2">
     <i class="fa fa-2x fa-check"></i>
  ...
  <div class="row mtop15p">
    <div class="col-xs-12">
	  <button class="btn btn-default form-control"><b>Signup</b></button>
	</div>
  </div>
  </div>
</div>
